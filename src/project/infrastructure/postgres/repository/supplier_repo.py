...
class SupplierRepository:
    ...
    async def get_supplier_by_id(
        ...
        query = (
            ...
            .where(self._collection.supplier_id == supplier_id)
        )
    ...
    async def create_supplier(
        self,
        session: AsyncSession,
        supplier: SupplierCreateUpdateSchema,
    ) -> SupplierSchema:
        query = (
        ...
        try:
            ...
            raise SupplierAlreadyExists(name=supplier.supplier_name)
    ...
    async def delete_supplier(
        ...
        query = delete(self._collection).where(self._collection.supplier_id == supplier_id)
